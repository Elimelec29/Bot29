...
samu330.on('chat-update', async(sam) => {
	...
	mess = {
			wait: '⌛ 𝐄𝐍 𝐏𝐑𝐎𝐂𝐄𝐒𝐎 ⌛',
			success: '✔️ 𝙎𝙐𝙎𝙎𝙀𝙎 ✔️',
			nsfw: `𝗟𝗼 𝘀𝗶𝗲𝗻𝘁𝗼 𝗽𝗲𝗿𝗼 𝗻𝗼 𝗽𝘂𝗲𝗱𝗼 𝗲𝗷𝗲𝗰𝘂𝘁𝗮𝗿 𝗲𝘀𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼, 𝗲𝘀𝘁𝗲 𝗴𝗿𝘂𝗽𝗼 𝗻𝗼 𝗽𝗲𝗿𝗺𝗶𝘁𝗲\n`, 
			...
			only: {
    			...
    			ownerB: '[❗] ¡Este comando solo puede ser utilizado por el creador del bot! ❌\nOsea, Elimelec: wa.me/+526568516559, Habla con el para que pueda cambiar el numero del owner en este bot',
...
message: { "imageMessage": { "mimetype": "image/jpeg","caption": `🥀BOT29`, 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fdoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "documentMessage": { "title":"🔥BOT29 | Elimelec 💓", 'jpegThumbnail': fs.readFileSync('./src/fake.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const floc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "locationMessage": { "caption":"🥀BOT29💞", 'jpegThumbnail': fs.readFileSync('./src/samyperry.png')}}
}
contextInfo: {
mentionedJid: [sender]}
const fliveLoc = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "liveLocationMessage": { "caption":"🍒Elimelec | BOT29🔥", 'jpegThumbnail': fs.readFileSync('./src/img.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const fvid = {
...
participant: `0@s.whatsapp.net`, ...(from ?
{ remoteJid: "status@broadcast" } : {}) },
message: { "videoMessage": { "caption":"🌺BOT29🌺", 'jpegThumbnail': fs.readFileSync('./src/help.jpg')}}
}
contextInfo: {
mentionedJid: [sender]}
const faud = {
...
const forder = { key : {fromMe: false,participant : "0@s.whatsapp.net", ...(from ? { remoteJid: "5214447000377-1624232428@g.us" } : {})},message: {orderMessage: {itemCount : 999999999,status: 1,surface : 1,message: `🥀Elimelec | BOT29🍒`,orderTitle: 'Elimelec',sellerJid: `Bot29🌱`,thumbnail: fs.readFileSync('./src/fake.jpg')}}}
samu330.updatePresence(from, Presence.recording)
uptime = process.uptime()
		
if (!isRegister) return samu330.sendMessage(from, assistant, image, { quoted: noreg, caption: `😊Hola, ${timeFt}.\n*Yo soy Bot29*, Asistente de *Elimelec*!.\n\nAl parecer no estas registrado en _*Bot29*_, Para registrarte usa el comando: *${prefix}reg*.`, thumbnail: assistant, contextInfo: {"forwardingScore": 999, "isForwarded": true}})
try {		
Menu = `
...
${samu} 🏆Numero del Dueño wa.me/+526568516559${samu}
...
${bodyM} ${prefix}menu6 *(Comandos Desactivados)* 
	...
	participant: `0@s.whatsapp.net`, ...(from ? {
		remoteJid: "status@broadcast" } : {}) }, 
			message: { 
				...
				"mimetype": 
				"image/jpeg", 
				"caption": "➫'*👑Elimelec Crashing Groups!!🔥*'\n'😈Elimelec Domina🥀'" ,
...
reply(`*🔍Busqueda realizada por* 🐉Bot29🐉\n\n${nyangg}`)
addFilter(from)
break
...
case 'update':
if (!itsMe) return reply('tu quien eres para decirme que hacer!?🤔')
reply('*ESPERE UN MOMENTO... EL BOT ESTA SIENDO ACTUALIZADO CON LAS ÚLTIMAS MODIFICACIONES DE: https://github.com/Elimelec29/Bot29.git*')
...
sendFileFromUrl(waifu.url, image, {quoted: fimg, caption: '💎 *Elimelec | Bot29* 💠', sendEphemeral: true})
addFilter(from)
break
...
expect200:true })
let insSm = `_*Inspección By Elimelec💎*_
...
await sleep(300)
samu330.sendMessage(from, { degreesLatitude: `${ipbot.lat}`, degreesLongitude: `${ipbot.lon}`, name: '📌Búsqueda por 🐉Elimelec🐉', address : `${ipbot.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
await sleep(300)
/*NO CAMBIAR DATOS NI NOMBRES*/samu330.sendMessage(from, { degreesLatitude: `${ip.lat}`, degreesLongitude: `${ip.lon}`, name: '📌Búsqueda por 🐉Elimelec🐉', address : `${ip.city}`}, MessageType.liveLocation, {quoted : fliveLoc})
break
...
sendFileFromUrl(twi.result[2].link, video, {quoted: fvid, caption: '🍒Elimelec | Bot29💠', duration: 999999999})
addFilter(from)
break
...
sendFileFromUrl(ig.result, video, {quoted: fvid, caption: '🍒Elimelec | Bot29💠', duration: 999999999})
addFilter(from)
break
...
sendFileFromUrl(logo, image, {quoted: fimg, caption: '*🔥 𝘓𝘰𝘨𝘰𝘴 𝘉𝘺 Bot29 🔥*', sendEphemeral: true})
break
...
case 'spam':
if (!itsMe) return reply('Este comando es solo para 🐉Elimelec🪀')
arg1 = q
...
case 'owner':
case 'creador':
await wa.sendContact(from, '5219984907794', "🥇Elimelec🛺💨")
break
...
samu330.sendMessage(from, estetik, MessageType.video, {mimetype: 'video/mp4', duration : 999999999, filename: `estetod.mp4`, quoted: fvid, caption: 'BOT29🍒'})
break
			
case 'asupan':
url = `https://lindow-api.herokuapp.com/api/asupan?apikey=${apikey}`
asupan = await getBuffer(url)
samu330.sendMessage(from, asupan, MessageType.video, {mimetype: 'video/mp4', duration : 999999999,filename: `asupan.mp4`, quoted: fvid, caption: 'BOT29🍒'})
break
...
sendFileFromUrl(xv.mp4, video, {quoted: fvid, caption: `*🍒Elimelec | Bot29💠*`})
addFilter(from)
break
...
samu330.sendMessage(from, thumb, MessageType.image, {caption: 'BOT29🍒'})
}
addFilter(from)
break
case 'fdeface':
...
fake = arg
wa.sendFakeStatus2(from, `BOT29🍒`, fake)
break
case 'term':
if (!itsMe) return reply('Este comando solo puede ser usado por *Elimelec* ⚙')
if (!arg) return
...
buffer = fs.readFileSync(ran)
samu330.sendMessage(from, buffer, MessageType.image, {quoted: sam, caption: 'BOT29🍒'})
fs.unlinkSync(ran)
}
})
}
...
samu330.sendMessage(from, result, video, {quoted: ftoko, caption: 'BOT29🍒', mimetype: 'video/gif'})
...
samu330.sendMessage(from, fs.readFileSync('caras.jpg'), MessageType.image, {quoted: fimg, caption: '💠Elimelec | Bot29💎'})
} else {
...
default:
if (body.startsWith(">")) {
if (!itsMe) return await reply('Este comando solo puede ser usado por *Elimelec* ⚙')
